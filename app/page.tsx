...
export default function Home() {
  ...
  return <main className="app-shell">
    ...
    <div className="workspace-page">
      ...
      {data && <MarketWorkspace stocks={stocks} ticker={ticker} onSelect={selectTicker} chart={<ChartWorkspace rows={data.candles} holdings={data.holdings} holdingChanges={data.holdingChanges} power={data.power} direction={data.direction} rs={data.rs} ticker={ticker} name={name}/>}/>}
    </div>
